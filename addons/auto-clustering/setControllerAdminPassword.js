...
return jelastic.env.control.ExecCmdById('${env.envName}', session, TARGET_NODE, toJSON([{ "command": "/bin/bash /opt/wildfly/bin/add-user.sh", "params": adminUserCredentials }]), false, "root");
