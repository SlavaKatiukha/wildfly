...
return jelastic.env.control.ExecCmdById('${env.envName}', session, TARGET_NODE, toJSON([{ "command": "/usr/bin/sh /opt/wildfly/bin/add-user.sh", "params": adminUserCredentials }]), false, "root");
